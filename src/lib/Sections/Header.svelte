...
>
	<div class="header-container">
		...
		<div class="title">
			<h1 class="lucas begin-invisible gradient-accented" class:transitioned>jeremy</h1>
			<h1 class="gover begin-invisible gradient-accented" class:transitioned>From Accounting</h1>
		</div>
	</div>
</section>
