...
if __name__ == '__main__':
    ...
    for i in range(32):
        ...
        room_number = (5-len(room_number))*'0' + room_number
        index = int(room_number,2)
        rooms['nodes'] += [make_item_dict(index, room_number, room_number[1:])]
        print(room_number)
    ...
    with open("./static/5d_hypercube.json", 'w') as json_file:
